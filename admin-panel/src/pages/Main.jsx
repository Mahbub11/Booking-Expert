    ...
    <Layout className='w-full h-screen'>
      ...
      <Layout>
        <Header className='p-0 !bg-bg-white'>
          <Link to='/'>
            <h1 className='p-2 m-auto flex justify-center font-bold text-3xl mt-4  text-blue-500'>B00KING EXPERT</h1>
          </Link>
        ...
        <Content className='bg-bg-white overflow-y-scroll m-2 p-2'>
          ...
          {selectedKeys === '4' && (<Bookings />)}
          {selectedKeys === '5' && (<MyProfile />)}
        </Content>

        <Footer className='text-center font-text-font font-medium text-blue-400 '>
          @ 23023 Booking Expert
          {' '}
        </Footer>
      </Layout>
    </Layout>
